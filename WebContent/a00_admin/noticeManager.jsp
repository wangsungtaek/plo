...
<body>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-3 text-gray-800">공지사항 정보</h1>
					</div>
							...
							<div class="table-responsive">
								...
								<table class="table table-bordered table-hover" id="dataTable"
									...
									<tbody>
										...
										<tr ondblclick="detail(${notice.n_no})">
											<td>${notice.n_no}</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">공지사항 상세</h5>
	...
	<script>
		...
		function detail(no){
			xhr.open("get", "${path}/a00_admin/z06_noticeDetail.jsp?no="+no, true);
			xhr.onreadystatechange = function() {
				if(xhr.readyState == 4 && xhr.status == 200){
					var notice = JSON.parse(xhr.responseText);
					$('[name=n_no]').val(notice.n_no);
