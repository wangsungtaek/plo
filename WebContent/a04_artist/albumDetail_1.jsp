...
.more-content${music}{
  display:none;  position: absolute;  background-color: white;  min-width: 200px;  z-index: 1;  padding: 10px 0px;
    box-shadow: 0px 0px 1px 3px whitesmoke;  border-radius: 2px;
}

.more-content${music} a {
  text-align: left;  display: block;  color: black;  padding: 12px 16px;  font-size: 10pt;
...
.album_title:hover{
	color : #FF8533;}
.artist_name{
	display : block;font-size : 17px;  margin-top : 20px; height : 50px;}	
.etc_info span{
...
#like_img2{
	width : 25px; height : 20px; position : relative; }
.btn_nav{
	position : absolute;   margin-top:180px;   margin-left : -35px;  top : 330px; }
.btn_list{
    display:flex;}
.btn_list li{
...
<div class="container-fluid" style="background: white;">
      <jsp:include page="music-check.jsp"></jsp:include>
		...
		<div class="main_info">
		   <div class="profile_box">
			   <img class="profile_img" src="${path}${albumDetail.alb_img}">
			</div>
		   	...
		   	<div class="info_box">
		   		<p class="album_title">${albumDetail.alb_name}</p>
		   		<span class="artist_name"><a href="${path}/a04_artist/albumDetail_1.jsp">${albumDetail.art_name} ></a></span>
		   		<p class="etc_info">		   			
		   			<span class="form">${albumDetail.art_group}</span>&nbsp;&nbsp;|&nbsp;
		   			<span class="genre">${albumDetail.genre_name}</span>
		   		</p>
	...
	<div class="btn_nav">
		<form method="post">
	       <ul class="btn_list">
	           <li><a href="${path}/albumdetail2?alb_no=5" id="unselect">상세정보</a></li>
	           <li id="li_select"><a href="${path}/albumdetail1?alb_no=5" id="select">수록곡</a></li>
	       </ul>
	      </form>
     </div>
                        ...
                        <div class="chart-table">
                            <table style="width: 100%;">
                                ...
                                <tbody>
                                     ...
                                     <div class="songinfo">
                                     <c:forEach var="album" items="${alblist}" varStatus="status">   
                                        <tr>
                                            ...
                                            <td width="51%" class="tableheaderchild">
                                                <div class="title_image" style="background-image: url(${path}${album.alb_img})"></div>
                                                <div class="title_album">
                                                    <span><a href="${path}/a04_artist/albumDetail_1.jsp">${album.m_name}</a></span>
                                                    <span><a href="${path}/a04_artist/albumDetail_1.jsp">${album.alb_name}</a></span>
                                                </div>
                                            </td>
                                            <td width="16%" class="tableheaderchild"><a href="${path}/a04_artist/artistDetail_1.jsp">${album.art_name}</a></td>
                                            <td width="6%">
