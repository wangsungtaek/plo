...
.order_famous:hover, .order_recent:hover, .order_abc:hover{
	color : #FF8533; cursor:pointer;}	
.album_tab{
    position : absolute; top : 550px; margin-top:15px; width:1080px; text-align : left;}
.album_tab tr{
    height:170px;  }
.album_tab span{
    margin-left:8px; }
...
<body>
	<div class="page">
	  <div class="wrapper">
		...
		<div class="btn_nav">
	       <ul class="btn_list">
	           <li><a href="artistDetail_1.jsp" id="unselect">곡</a></li>
	           <li id="li_select"><a href="artistDetail_2.jsp" id="select">앨범</a></li>
	       </ul>
      	</div>
      	<div class="up_tab">
