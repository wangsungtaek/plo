                                ...
                                <c:forEach var="music" items="${listkind[chartcnt]}" varStatus="status">
                                     <div class="songinfo">
                                        <tr>
                                            ...
                                            <td width="6%">
                                            	<form id="playbuttonM_noF">
                                            		<input type="hidden" name="playbuttonM_no" value="${playbuttonM_no }"/>
                                            	</form>
                                                <button type="button" name="playbutton${status.count}">
                                            ...
                                            <td width="6%">
                                            	<form id="playlistbuttonM_noF">
                                            		<input type="hidden" name="playlistbuttonM_no" value="${playlistbuttonM_no }"/>
                                            	</form>
                                                <button type="button" name="playlistbutton${status.count}">
                                                ...
                                                <div class="more-content${status.count}" name="more${status.count}">
                                                	<a id="thisSongInfoB${status.count}">
                                                		<a id="thisSongInfoF${status.count}" href="${path}/musicdetail?m_no=${music.m_no}">
                                                	...
                                                	<a id="thisAlbInfoB${status.count}">
                                                		<form id="thisAlbInfoF${status.count}">
                                                			<input type="hidden" name="thisAlbInfo" value="${music.alb_no}"/>
                                                		</form>
                                                	...
                                                	<a id="thisArtInfoB${status.count}">
                                                		<form id="thisArtInfoF${status.count}">
                                                			<input type="hidden" name="thisArtInfo" value="${music.art_no}"/>
                                                		</form>
