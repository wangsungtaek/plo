	...
	$(document).ready(function(){
	   ...
	   $("#modify").on("click",function(){
			if(check==0){
				...
				$(".tab_h2, .tab_h2_child").hide();
				check=1;
			}else{
				$(this).text("편집");
				$("#allplay").text("▷ 전체듣기");
				$("input[type=checkbox]").prop("checked",false);
				$(".tab_h2, .tab_h2_child").show();
				check=0;
			}
		});
	   var allcheck=0;
				...
				<div class="storage">
					<div class="storage-nav">
						<ul class="storage-list">
							...
							<li id="li_select"><a href="#" id="stor_select">♥ 곡</a></li>
							...
							<div class="songinfo">
			                	<tr>
			                        ...
			                        <td width="58%" class="tableheaderchild">
			                            ...
			                            <td width="6%" class="tab_h2_child">
			                			<button type="button" class="tab_h2_child">
