...
a{    text-decoration:none;  color:black; color: inherit;}
	...
	#stor_like_menu #modify{
		float:right;
		font-size:13px;
	}
	#stor_like_menu #modify:hover{
		color:blue;
		cursor:pointer;
	}
	.chart-title{
            ...
            <div class="col" id="tour">
                ...
                <div class="row">
                    <div class="col" id="main-header">
	                   	<input type="button" class="genre-icons" value="내 리스트" onclick="location.href='${path}/MyList.do'"></input>
                        <input type="button" class="genre-icons stor_select" style="background:orange" value="♡ 곡"></input>
                        <input type="button" class="genre-icons" value="♡ 앨범" onclick="location.href='${path}/LikeAlbum.do'"></input>
                        <input type="button" class="genre-icons" value="♡ 가수" onclick="location.href='${path}/LikeArtist.do'"></input>
                        <input type="button" class="genre-icons" value="많이 들은 곡" onclick="location.href='${path}/ManyMusicPlay.do'"></input>
                        <input type="button" class="genre-icons" value="최근 들은 곡" onclick="location.href='${path}/RecentMusicPlay.do'"></input>
                    </div>
                </div>
                <!--메인 차트-->
<!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  -->
                <div class="row">
                    <div class="col" style="width:100px">
                        ...
                        <div class="chart-title" style="padding:0px 15px">
                           <div id="stor_like_menu"><button id="allplay">▷ 전체듣기</button><button id="modify">편집</button></div>
                        </div>
                            ...
                            <table style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <td width="57%" class="tableheader">곡/앨범</td>
                                ...
                                <tbody>
                                	<c:forEach var="music" items="${lmlist}" varStatus="status">
                                     <div class="songinfo">
                                        <tr>
