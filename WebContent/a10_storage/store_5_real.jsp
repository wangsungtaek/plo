                ...
                <div class="row">
                    <div class="col" id="main-header">
	                   <input type="button" class="genre-icons" value="내 리스트" onclick="location.href='${path}/MyList.do'"></input>
                        <input type="button" class="genre-icons" value="♡ 곡" onclick="location.href='${path}/LikeMusic.do'"></input>
                        ...
                        <input type="button" class="genre-icons stor_select" style="background:orange" value="많이 들은 곡"></input>
                    ...
                    <div class="col" style="width:100px">
                        ...
                        <div class="chart-table">
                            <table style="width: 100%;">
                                ...
                                <tbody>
                                	<c:forEach var="music" items="${rinfolist}" varStatus="status">
                                     <div class="songinfo">
                                        <tr>
                                            ...
                                            <td width="57%" class="tableheaderchild">
                                                ...
                                                <div class="title_album">
                                                    ...
                                                    <span>${music.alb_name }&nbsp;&nbsp;&nbsp;&nbsp;♬&nbsp;${mcntlist.get(status.index)}</span>
                                                </div>
                                            </td>
